...
const { Size, createHaberdasherClient } = __webpack_require__(2)
...
module.exports=function(t){var n={};function e(r){if(n[r])return n[r].exports;var o=n[r]={i:r,l:!1,exports:{}};return t[r].call(o.exports,o,o.exports,e),o.l=!0,o.exports}return e.m=t,e.c=n,e.d=function(t,n,r){e.o(t,n)||Object.defineProperty(t,n,{configurable:!1,enumerable:!0,get:r})},e.r=function(t){Object.defineProperty(t,"__esModule",{value:!0})},e.n=function(t){var n=t&&t.__esModule?function(){return t.default}:function(){return t};return e.d(n,"a",n),n},e.o=function(t,n){return Object.prototype.hasOwnProperty.call(t,n)},e.p="",e(e.s=1)}([function(t,n){var e=function(t){return JSON.stringify(t.toObject())},r=function(t){return t.json()};function o(t){var n=new Error(t.msg);return n.meta=void 0===t.meta?{}:t.meta,n.code=t.code,n}function i(t,n){var e=new t;return Object.keys(n).forEach(function(t){var r="set"+t[0].toUpperCase()+t.slice(1);r in e&&e[r](n[t])}),e}t.exports=function(t,n,u){return function(c,a,s,f,p){var l,d,h,w,y=c.replace(/\/$/,"")+"/twirp/"+a+"/",b=f?e:n,m=(l=p,d=f?"application/json":"application/protobuf",h=s,(w=Object.keys(l).reduce(function(t,n){return t[n]=l[n],t},{}))["Content-Type"]=d,w.Accept=d,w["Twirp-Version"]=h,w),v=function(n,e,i){var c=f?r:u(i),a={method:"POST",body:b(e),redirect:"manual",headers:m};return t(y+n,a).then(function(t){return 200!==t.status?function(t){return t.json().then(function(t){if(!t.code||!t.msg)throw n(t);throw o(t)},function(){throw n({})});function n(n){return o({code:"internal",msg:"Error from intermediary with HTTP status code "+t.status+" "+t.statusText,meta:n})}}(t):c(t)})};return v.buildMessage=i,v}}},function(t,n,e){const r=e(0);"fetch"in window!=!1&&"function"==typeof fetch||console.warn("TWIRP RPC Client requires `window.fetch` and this browser doesn't support it\nPlease install a polyfill such as `whatwg-fetch` (https://github.com/github/fetch)");t.exports=r(window.fetch,function(t){return t.serializeBinary()},function(t){return function(n){return n.arrayBuffer().then(function(n){return t.deserializeBinary(new Uint8Array(n)).toObject()})}})}]);
